        ...
        <div className="space-y-8 text-muted leading-relaxed">
          ...
          <div>
            ...
            <p>
              ...
              Der Vertrag kommt mit der Zahlungsbestätigung zustande.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              Zahlung erfolgt über Stripe. Es werden folgende Zahlungsmethoden akzeptiert:
          ...
          <div>
            ...
            <p>
              ...
              Lieferung erfolgt in der Regel innerhalb weniger Minuten, spätestens
          ...
          <div>
            ...
            <p>
              ...
              Vertrag zu widerrufen. Um Ihr Widerrufsrecht auszuüben, müssen Sie uns
              per Email (kontakt@astro-masters.com) über Ihren Entschluss informieren.
            </p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-white mb-2">6. Haftung</h2>
            <p>
              Die bereitgestellten Analysen dienen ausschließlich der Unterhaltung und
