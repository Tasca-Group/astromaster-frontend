        ...
        <div className="space-y-8 text-muted leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              Standardvertragsklauseln der EU-Kommission gestützt. Details und
          ...
          <div>
            ...
            <p>
              Diese Website nutzt Brevo für den Versand von Newslettern. Anbieter
              ist die Sendinblue GmbH, Köpenicker Straße 126, 10179 Berlin,
              Deutschland.
            </p>
            <p className="mt-2">
              Brevo ist ein Dienst, mit dem u.a. der Versand von Newslettern
              organisiert und analysiert werden kann. Die von Ihnen zum Zwecke
              des Newsletterbezugs eingegeben Daten werden auf den Servern der
              Sendinblue GmbH in Deutschland gespeichert.
            </p>
            ...
            <p>
              ...
              eine Newsletter-Nachricht geöffnet und welche Links ggf.
            ...
            <p className="mt-2">
              Brevo ermöglicht es uns auch, die Newsletter-Empfänger anhand
            ...
            <p className="mt-2">
              Wenn Sie keine Analyse durch Brevo wollen, müssen Sie den
              Newsletter abbestellen. Hierfür stellen wir in jeder
              Newsletternachricht einen entsprechenden Link zur Verfügung.
            </p>
            <p className="mt-2">
              Ausführliche Informationen zu den Funktionen von Brevo entnehmen
              Sie folgendem Link:{" "}
              <a
          ...
          <div>
            ...
            <p>
              ...
              Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. b DSGVO, der die
              ...
              Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO erteilt haben, werden
              wir Ihre E-Mail-Adresse an das mit der Lieferung betraute
              Transportunternehmen übergeben, damit dieses Sie per E-Mail über
              den Versandstatus Ihrer Bestellung informieren kann; Sie können die
            ...
            <p>
              ...
              ein. Wenn Sie einen Kauf bei uns tätigen, werden Ihre
            ...
            <h4 className="font-semibold text-white mt-4 mb-1">Stripe</h4>
            <p>
